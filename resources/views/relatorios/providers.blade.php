...
<div style="width: 100%" align="center">
    <p style="margin: 0; font-size: 25px">Relatório de Fornecedores</p>
    <br>
</div>
<div style="width: 100%">
...
<table width="100%" style="border: 1px solid black; border-collapse: collapse;">
    ...
    <tr style="background-color: rgba(143,152,142,0.47);">
        ...
        <td style="border: 2px solid"><strong>FANTASIA</strong></td>
        <td style="border: 2px solid"><strong>ENDEREÇO</strong></td>
        <td style="border: 2px solid"><strong>CONTATOS</strong></td>
    </tr>
    <tbody>
        @foreach(\App\ProvidersModel::all()->where('company_id', \Illuminate\Support\Facades\Auth::user()->company_id) as $product)
            <tr>
