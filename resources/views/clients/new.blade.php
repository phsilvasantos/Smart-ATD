                        ...
                        <form action="{{route('clients.store')}}" method="post">
                            ...
                            <input type="hidden" name="company_id" value="{{\Illuminate\Support\Facades\Auth::user()->company_id}}">
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" placeholder="Nome Completo" required>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                                ...
                                <div class="col-md-5 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="date" class="form-control has-feedback-left" name="nasc_date" id="inputSuccess2" placeholder="Data de Nascimento" required>
                                    <span class="fa fa-birthday-cake form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" name="phone" id="inputSuccess2" placeholder="Telefone Fixo" data-inputmask="'mask': '(99) 9999-9999'" required>
                                    <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" name="cell_phone" id="inputSuccess2" placeholder="Celular" data-inputmask="'mask': '(99) 9 9999-9999'" required>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" name="cep" id="inputSuccess2" placeholder="CEP" required data-inputmask="'mask': '99.999-999'">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        ...
                                        <textarea class="form-control" name="description" placeholder="Insira as referências comerciais do cliente..." required></textarea>
                                    </div>
