                        ...
                        <tr>
                            ...
                            <td>
                                @if($bill->status==0)
                                    ...
                                    @endif
                                    @if($bill->venc_date > date('Y-m-d'))
                                        <span class="label label-primary">A Pagar</span>
                                    @endif
                            ...
                            @if($bill->status==0)
                            <td align="center">
                                <a href="{{route('bills.pay',$bill->id)}}"><span class="label label-default">Pagar</span></a>
                                <a href="{{route('bills.remove', $bill->id)}}"><span class="label label-danger">Excluir</span></a>
                            </td>
                            @elseif($bill->status==1)
                                <td align="center">
                                    Pago em {{\Carbon\Carbon::parse($bill->pay_date)->format('d/m/y')}}
                                </td>
                            @endif
                        </tr>
                        @endif
